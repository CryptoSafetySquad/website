...
const earnings: EarningsEntry[] = [
  ...
  { label: '2 Aug 23', date: '2023-08-02', ethereum: { usdc: 3.45 }, amount: 3.45 }, // YLD $225 - % - $300  %
  { label: '4 Sep 23', date: '2023-09-04', ethereum: { usdc: 3.34 }, amount: 3.34 }, // YLD $225 - % - $300  %
  { label: '7 Oct 23', date: '2023-10-07', ethereum: { usdc: 2.55 }, amount: 2.55 }, // YLD $225 - % - $300  %
