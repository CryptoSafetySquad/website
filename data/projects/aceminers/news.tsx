const news = [
  { date: '15/03/2023', content: (<>P2 Final NFTs minted: <a href='https://etherscan.io/tx/0x766a8f8dbc79bfad0a04880e85c0d8720154e2045a1c6833cc32b0b756deb74f' target='_blank' rel='noopener noreferrer'>Etherscan</a></>) },
  ...
  { date: '20/10/2022', content: (<>1st payout to P1 holders (<span className='blockchain polygon'>Polygon</span>) ~$16</>) }
]
