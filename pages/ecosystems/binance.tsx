    ...
    <>
      <div className='grid grid-cols-3 gap-2'>
        ...
        <div className='card'>
          ...
          <p><ExternalLink href='https://www.aequinox.exchange/#/' text='Aequinox' /></p>
        </div>

        <div className='card'>
          <h2 className='mb-2'>DeFI (Decentralised Finance)</h2>
          <p><ExternalLink href='https://app.beefy.com/' text='Beefy' /></p>
          <p><ExternalLink href='https://magik.farm/#/bsc' text='Magik' /></p>
          <p><ExternalLink href='https://autofarm.network/' text='Autofarm' /></p>
        </div>
      </div>
    </>
  )
