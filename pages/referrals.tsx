...
const Referrals: NextPage = () => {
  const title = 'Referrals / Useful Links'
  const content = (
    <>
      ...
      <div className='card'>
        <h2 className='text-secondary mb-4 text-2xl'>Exchanges</h2>
      ...
      <div className='card'>
        <h2 className='text-secondary mt-4 mb-4 text-2xl'>Trading Platforms</h2>
        <div className='grid grid-cols-4 gap-2'>
      ...
      <div className='grid grid-cols-3 mt-4'>
        <div className='card with-bg'>
          ...
          <p className='text-sm mb-2'>Eth/Polygon: <span className='text-secondary'>0xdC386A6A27C6D21D1eDC96Ba8b427FbA545c1E1B</span></p>
        </div>
      </div>
    </>
  )
